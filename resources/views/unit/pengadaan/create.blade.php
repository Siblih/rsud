...
<div class="min-h-screen bg-gradient-to-b from-[#1A1F4A] to-[#2B3370] text-white pb-24 px-4 pt-6">
  <div class="max-w-md mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <h1 class="text-lg font-bold text-white">📝 Ajukan Pengadaan</h1>
      <div class="w-6"></div>
    </div>
    ...
    <form method="POST" action="{{ route('unit.pengadaan.store') }}"
      ...
      <div class="pt-3">
        <button type="submit"
                class="w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold py-3 rounded-xl shadow-md hover:opacity-90 active:scale-95 transition-all">
          🚀 Kirim Pengajuan
        </button>
      </div>
    </form>
